...
# https://github.com/liviaalmeida/clustering
# Arguments: python PSO.py n_particles n_clusters inertia_max inertia_min fcognitive(c1) fsocial(c2) iterations input_file
# Run with: python POS.py 30 3 0.9 0.5 1.5 1.5 30 data/artificial
